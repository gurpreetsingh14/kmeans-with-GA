...
class generate_data:
    ...
    def raw_data(self):
        ...
        for i in range(len(input_list)):
            X_coordinate_list = self.data_generation(input_list[i][0],input_list[i][1],input_list[i][2],
                                                input_list[i][3],input_list[i][4])[0]
            Y_coordinate_list = self.data_generation(input_list[i][0],input_list[i][1],input_list[i][2],
